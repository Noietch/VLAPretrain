...
if __name__ == "__main__":
    ...
    video_dir = "datasets/libero_debug/video"  # Option 2: Multiple videos
    video_pattern = "*_eye.mp4"  # Pattern: "*.mp4", "*_eye.mp4", "demo_*.mp4"

    base_output_dir = "datasets/libero_debug/latent_action"
