...
parser.add_argument('--laq_checkpoint', type=str, required=True, help='Path to the laq checkpoint', default='huggingface/latent-action-pretraining/LAPA-7B-openx/laq_openx.pt')
