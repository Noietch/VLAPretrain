...
/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/yiyang11/conda/lerobot_rdt/bin/torchrun --nproc_per_node=8 /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/yiyang11/data_pross/latent_action_model/gen_latent_lapa_video_ddp.py \
    --video_dir /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/yiyang11/datasets/lerobot_2 \
    --base_output_dir /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/native_mm/yiyang11/datasets/lerobot_2/latent_action/